    ...
    <div className="add-task-page">
      <div className="page-header-row">
        <div>
          ...
          <p>Define task parameters, lifecycle status, priority level, and deadline</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card task-form-card">
          <div className="form-group">
            ...
            <input
              id="task-header"
              type="text"
              placeholder="e.g. Conduct Vulnerability Review"
              value={header}
          ...
          <div className="form-group">
            ...
            <textarea
              id="task-desc"
              rows="4"
              placeholder="Detail the scope of work, technical context, or required deliverables..."
              value={description}
          ...
          <div className="auto-timestamp-banner">
            ...
            <div className="auto-timestamp-content">
              ...
              <span>Automatically captured as <code>{autoPickedTime}</code></span>
            </div>
          </div>
